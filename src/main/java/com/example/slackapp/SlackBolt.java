...
public class SlackBolt {
        ...
        public SocketModeApp boltApp() throws IOException {
                ...
                // add a message listener to the app
                // compose regex pattern to match all messages
                SlackMessageHandler slackMessageHandler = new SlackMessageHandler();
                Pattern captureAll = Pattern.compile(".*");
                app.message(captureAll, slackMessageHandler.eventHandler());
